...
static const struct ieee80211_regdomain regdom_AR = {
	.alpha2 = "AR",
	.reg_rules = {
		REG_RULE(2402, 2482, 40, 0, 36, 0),
		REG_RULE(5170, 5330, 160, 6, 23, 0),
		REG_RULE(5490, 5590, 80, 6, 36, 0),
		REG_RULE(5650, 5730, 80, 6, 36, 0),
		REG_RULE(5735, 5835, 80, 6, 36, 0),
	},
	.n_reg_rules = 5
};
...
static const struct ieee80211_regdomain regdom_BZ = {
	...
	.reg_rules = {
		REG_RULE(2402, 2482, 40, 0, 36, 0),
		REG_RULE(5170, 5330, 160, 0, 27, 0),
		REG_RULE(5490, 5730, 160, 0, 36, 0),
		REG_RULE(5735, 5835, 80, 0, 36, 0),
	},
	.n_reg_rules = 4
};
...
static const struct ieee80211_regdomain regdom_KR = {
	...
	.reg_rules = {
		...
		REG_RULE(5490, 5710, 80, 6, 30, 
			NL80211_RRF_DFS | 0),
		REG_RULE(5735, 5835, 80, 6, 30, 0),
		REG_RULE(57000, 66000, 2160, 6, 43, 0),
	},
	.n_reg_rules = 6
};
...
static const struct ieee80211_regdomain regdom_TT = {
	...
	.reg_rules = {
		REG_RULE(2402, 2482, 40, 0, 20, 0),
		REG_RULE(5170, 5330, 160, 6, 27, 0),
		REG_RULE(5490, 5730, 160, 6, 36, 0),
		REG_RULE(5735, 5835, 80, 6, 36, 0),
	},
	.n_reg_rules = 4
};
